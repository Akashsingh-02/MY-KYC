...
for (var i = 0, j = 0; i < (oldData.length - 2); ++i){
 ...
 document.getElementById("bank_rating").innerHTML = (contractInstance.getCustomerBankRating.call(usewr_name,
 {
 	from: current_account,
 	gas: 4700000
 })) / 100;
